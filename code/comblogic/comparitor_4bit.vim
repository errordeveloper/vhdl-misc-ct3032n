...
silent only
cd ~/uni/ct3032n/vhdl/ast_2.git/code/comblogic
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 comparitor_4bit.vhd
badd +0 http://esd.cs.ucr.edu/labs/tutorial/comparator.vhd
args comparitor_4bit.vhd http://esd.cs.ucr.edu/labs/tutorial/comparator.vhd
edit comparitor_4bit.vhd
...
1
normal! 0
lcd ~/uni/ct3032n/vhdl/ast_2.git/code/comblogic
wincmd w
exe 'vert 1resize ' . ((&columns * 71 + 71) / 142)
exe 'vert 2resize ' . ((&columns * 70 + 71) / 142)
tabnext 1
